...
<body class="bg-slate-100">
    <?php if (!session()->checkLogin()) : ?>
        <div class="flex justify-center items-center bg-white">
            <svg class="h-20 w-20" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-gray-700 font-semibold text-2xl">Phonebook Directory</span>
        </div>
    <?php endif; ?>
